...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/zybergeek", handle: "@zybergeek", icon: Github },
  { label: "Twitter", href: "https://twitter.com/zybergeek", handle: "@zybergeek", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/in/zybergeek", handle: "/in/zybergeek", icon: Linkedin },
  { label: "Email", href: "mailto:hello@zybergeek.dev", handle: "hello@zybergeek.dev", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="pt-2">
              <a
                href="mailto:hello@zybergeek.dev"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} ZYBERGEEK — All experiments reserved
          </p>
        </div>
      </div>
    </footer>
