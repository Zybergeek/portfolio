      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
        <nav className="flex items-center justify-between">
          <Link href="/" className="group flex items-center gap-3">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-lg border border-primary/50 bg-primary/10 font-display text-sm font-bold text-primary transition-all duration-400 group-hover:border-primary group-hover:bg-primary group-hover:text-primary-foreground group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-primary/25">
              <span>z</span>
            </div>
            <span className="font-serif font-bold text-sm tracking-tight">Zybergeek</span>
          </Link>
          ...
          <div className="hidden items-center gap-1 md:flex">
            {navItems.map((item, index) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "relative px-4 py-2.5 font-display text-xs uppercase tracking-wider transition-all duration-300 rounded-lg",
                  isActive(item.href)
                    ? "text-primary"
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden items-center gap-2.5 font-display text-xs text-muted-foreground sm:flex px-3 py-1.5 rounded-full bg-secondary/50 border border-border/50">
          ...
          <div className="flex flex-col gap-1 border-t border-border/50 pt-4">
            {navItems.map((item, index) => (
              <Link
                ...
                className="flex items-center gap-3 rounded-lg px-4 py-3.5 font-display text-sm uppercase tracking-wider text-muted-foreground transition-all duration-200 active:bg-secondary hover:text-foreground hover:bg-secondary/50"
              >
